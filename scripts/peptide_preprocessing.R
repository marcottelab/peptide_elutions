...
parser$add_argument('--orthouniq_peps', dest='orthouniq_peps', action='store', required=FALSE,
    help='File of all peptides unique to an orthogroup')

parser$add_argument('--close_orthology', dest='close_orthology', action='store', required=FALSE,
